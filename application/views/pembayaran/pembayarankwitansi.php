...
<html lang="en" id="areaprint">
  <head>
    ...
    <title>SpeApp - Bukti Pembayaran</title>
  ...
  <body>
    <header class="clearfix">
      ...
      <div id="company" class="clearfix">
        <div>SMK Negeri 1 Banjar</div>
        <div> Jl. KH Mustopa Lingk. Parung Lesang RT 05 RW 10,<br /> Banjar, Kec. Banjar, Kota Banjar Prov. Jawa Barat</div>
        <div>(602) 519-0450</div>
        <div><a href="#">www.smkn2jeneponto.sch.id</a></div>
      </div>
      <div id="project">
