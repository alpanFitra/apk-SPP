...
<head>
	...
	<title>SpeApp - Data Petugas</title>
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<a href="<?php echo site_url('datapetugas/form'); ?>" class="btn btn-success bg-gradient-success" style="background: linear-gradient(to bottom, #84d9d2, #07cdae) !important; font: bold;"><i class="fas fa-plus-circle" style="color: white;"></i> Tambah Petugas</a>
						</div>
						<div class="card-body">
