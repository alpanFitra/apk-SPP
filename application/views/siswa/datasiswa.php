				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<a href="<?php echo site_url('datasiswa/form'); ?>" class="btn btn-success bg-gradient-success" style="background: linear-gradient(to left, #84d9d2, #07cdae) !important;"><i class="fas fa-plus-circle" style="color: white;"></i> Tambah Siswa</a>
						</div>
						<div class="card-body">
