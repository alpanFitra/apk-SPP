				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<a href="<?php echo site_url('dataspp/form'); ?>" class="btn btn-success bg-gradient-success" style="background: linear-gradient(to left, #84d9d2, #07cdae) !important;"><i class="fas fa-plus-circle" style="color: white;"></i> Tambah SPP</a>
						</div>
						<div class="card-body">
									...
									<tbody>
										...
										?>
											<tr class="odd gradeX">
												...
												<td align="right">Rp. <?php echo number_format($d['nominal'], 2, ",", "."); ?></td>
